...
public class ChickenChop extends Item {
    public ChickenChop(Properties p_41383_) {
        super(p_41383_);
    }

    public ItemStack finishUsingItem(ItemStack p_42923_, Level p_42924_, LivingEntity p_42925_) {
        p_42925_.setHealth(p_42925_.getHealth() + p_42923_.getItem().getFoodProperties().getNutrition());
    ...
    {
        String string = "tooltip.smc.chicken_chop";
