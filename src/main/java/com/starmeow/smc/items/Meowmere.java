...
public class Meowmere extends SwordItem {
    public Meowmere(Tier p_43269_, int p_43270_, float p_43271_, Properties p_43272_) {
        super(p_43269_, p_43270_, p_43271_, p_43272_);
    }
    @Override
    public Component getName(ItemStack stack) {
        int[] colors = {
                ItemHelper.colorToInt(251, 192, 247),
                ItemHelper.colorToInt(228, 122, 231),
                ItemHelper.colorToInt(251, 192, 247),
                ItemHelper.colorToInt(240, 232, 240),
                ItemHelper.colorToInt(189, 242, 246),
                ItemHelper.colorToInt(111, 202, 232),
                ItemHelper.colorToInt(189, 242, 246)
        };
