...
public class FrostCakeSlice extends Item {
    public FrostCakeSlice(Properties p_41383_) {
        super(p_41383_);
    }
    ...
    public ItemStack finishUsingItem(ItemStack p_42923_, Level p_42924_, LivingEntity p_42925_) {
        ...
        for (LivingEntity target : entities) {
            ...
            if(target instanceof Mob mob){
                if(mob.getTarget() != null && mob.getTarget().is(p_42925_)){
                    target.addEffect(new MobEffectInstance(PotionEffectRegistry.FROST.get(), 200, 0));
                }
            }
        }
    ...
    {
        String string = "tooltip.smc.frost_cake";
